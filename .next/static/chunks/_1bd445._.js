(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_1bd445._.js", {
...
const documentSlice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$app$2e$slice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createAppSlice"])({
    ...
    reducers: (create)=>({
            ...
            upload: (state, action)=>{
                ...
                state.data.amount = state.data.amount = state.data.default_language == "en" ? state.data.amount.slice(0, 1) + ' ' + (Number(state.data.amount.slice(2, state.data.amount.length).replace(/[\s,]/g, '')) * __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["JPY_to_USD"]).toFixed(2).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : state.data.amount;
...
"[project]/lib/features/document_ocr/dashboard.slice.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const getDashboardData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('getDashboardData', async (filterData)=>{
    console.log("Dashboard Slice");
    selectedCurrency = filterData.currency;
    const response = await getAllValue(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$dbconfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DBConfig"].invoiceTable);
    return response;
});
const dashboardSlice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$app$2e$slice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createAppSlice"])({
    name: "dashboard",
    // `createSlice` will infer the state type from the `initialState` argument
    initialState,
    // The `reducers` field lets us define reducers and generate associated actions
    ...
    extraReducers (builder) {
        builder.addCase(getDashboardData.pending, (state)=>{
            ...
            if (action.payload) {
                const itemList = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ParseAllObjects"])(action.payload);
                if (itemList?.length) {
...
//# sourceMappingURL=_1bd445._.js.map