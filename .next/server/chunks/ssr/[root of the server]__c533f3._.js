...
const generateToken = async ()=>{
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].post("/api/auth/guard-user-signin", {}, {
        auth: {
...
async function ProductsPage(props) {
    ...
    const getData = async ()=>{
        try {
            console.log("RESPONSE", "HELLO WORLD 2!");
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$axios$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].get('/api/unicorncompanies'); // Replace with your API endpoint  
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__c533f3._.js.map