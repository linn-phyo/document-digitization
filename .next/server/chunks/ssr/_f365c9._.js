...
"[project]/lib/hooks/useIndexedDB.ts [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$dbconfig$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/lib/data/dbconfig.ts [app-rsc] (ecmascript)");
;
;
const useIndexedDB = (databaseName, tableNames)=>{
    ...
    const [isDBConnecting, setIsDBConnecting] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useState"])(true);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const initDB = ()=>{
            const request = indexedDB.open(databaseName, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$dbconfig$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["DBConfig"].version);
    ...
    const getValue = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useCallback"])((tableName, id)=>{
...
function DocumentListingPage() {
    const { putValue, getValue, getAllValue, updateValue, deleteValue, isDBConnecting } = useIndexedDB(DBConfig.name, [
        DBConfig.invoiceTable
    ]);
    let pageNo = 1;
    let newOffset = 0;
    let totalItems = 10;
    const invoiceList = ParseAllObjects(getAllValue(DBConfig.invoiceTable));
...
//# sourceMappingURL=_f365c9._.js.map