...
function decodeState(value) {
    try {
        ...
        return JSON.parse(decoder.decode(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$node$2f$esm$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__.base64url.decode(value)));
    } catch  {}
}
const state = {
    async create (options, data) {
        ...
        const encodedState = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$node$2f$esm$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__.base64url.encode(JSON.stringify({
            ...data,
    ...
    try {
        if (provider.type === "oauth" || provider.type === "oidc") {
            ...
            if (!user) {
                ...
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$errors$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["CredentialsSignin"]();
...
"[project]/node_modules/@auth/core/lib/index.js [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=node_modules_%40auth_core_ba7679._.js.map