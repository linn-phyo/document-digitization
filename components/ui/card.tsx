...
const CardHeaderSubTitle = React.forwardRef<
  HTMLParagraphElement,
  React.HTMLAttributes<HTMLHeadingElement>
>(({ className, ...props }, ref) => (
  <h1
    ref={ref}
    className={cn(
      "text-5xl italic leading-none tracking-tight",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn("text-2xl text-zinc-700", className)}
    {...props}
  />
))
...
export { Card, CardHeader, CardFooter, CardTitle, CardHeaderTitle, CardHeaderSubTitle, CardHeaderDescription, CardDescription, CardContent }
